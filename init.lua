...
--    :Lazy update
--
-- NOTE: Plugins (Use `opts = {}` to force a plugin to be loaded)
--
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      end, { desc = '[1] Fuzzily search in current buffer' })
      ...
      statusline.setup {
        ...
        content = {
          active = function()
            ...
            local filename = nil
            local fileinfo = MiniStatusline.section_fileinfo { trunc_width = 10000 } -- only show filetype
